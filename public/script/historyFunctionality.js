...
document.getElementById('selectMinistryHist').addEventListener('change', async (event) => {
    ...
    if (theHistory.length <= 1) {
        ...
        document.querySelector("p#noHistory").insertAdjacentHTML("afterbegin", `No history available for ${currentMinName}`);
    } else {
